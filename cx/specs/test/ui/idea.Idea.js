(function () {
    ...
    return { main: function () {
        ...
        const basics = section(root + "_b", "Idea", [
            gridField(model.fieldNameToModelId("title"), 12, "Title"),
            gridField(model.fieldNameToModelId("note"), 12, "Note", "Optional — the longer note behind the idea."),
            gridField(model.fieldNameToModelId("capturedAt"), 6, "Captured At")
        ]);
        return { sx: { p: 2, maxWidth: 720, minWidth: 320, mx: 'auto' }, elements: { [basics.id]: basics } };
    } };
})();